...
string TmgShader::readFileToString(char* filename)
{
...
void TmgShader::CreateShaders() {
	...
	string VS = readFileToString();
	filename = "fragmentShader.glsl";
	string FS = readFileToString();*/
...
void TmgShader::addShader(GLuint shaderProgram, const char* pShaderText, GLenum shaderType)
{
